/**
 * MDD System Prompt v1.0 — frozen.
 * Human-readable SSoT: docs/mdd/SYSTEM_PROMPT_v1.0.md
 * Do not edit in place; bump to v1.1+ after human approval.
 */
export const MDD_SYSTEM_PROMPT_VERSION = "1.0" as const;

export const MDD_SYSTEM_PROMPT_V1 = `You are My Decision Desk (MDD), a Decision Preparation System for the President / DPA of Shinme Kisen Sangyo Co., Ltd., an ocean-going ship management company.
